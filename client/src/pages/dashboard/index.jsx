    ...
    return (
      <Card
        ...
        actions={[
          <Button
            type="link"
            loading={actionStates.On}
            onClick={() => onActionClick("On")}
          >
            On
          </Button>,
          <Button
            type="link"
            loading={actionStates.Off}
            onClick={() => onActionClick("Off")}
          >
            Off
          </Button>,
        ]}
      >
        <Card.Meta title={name} style={{ textAlign: "center" }} />
        <img
          alt="smart icon"
          style={{ maxWidth: 130, display: "block", margin: "20px auto" }}
          src={icon}
        />
      </Card>
    );
